...
add wave -noupdate -label left {/tug_of_war_testbench/KEY[3]}
add wave -noupdate -label right {/tug_of_war_testbench/KEY[0]}
add wave -noupdate -label reset {/tug_of_war_testbench/SW[9]}
add wave -noupdate /tug_of_war_testbench/LEDs
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {4705 ps} 0}
...
update
WaveRestoreZoom {4255 ps} {6315 ps}
